...
mean(giantkelpset$longitude)
mean(giantkelpset$latitude)
```
```{r}
# Working with the .nc
...
hwdf_comp = Heatwavedf %>% 
  ...
  pivot_longer(cols = 3:5482,
               names_to = "days",
               values_to = "anomalies") # no applicable method for 'pivot_longer' applied to an object of class "c('integer', 'numeric')"
```