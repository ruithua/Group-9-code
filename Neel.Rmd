...
a = ggplot(onedf2, aes(x = year, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Year", y = "Percent Cover", title = "Giant Kelp Percent Cover Compared to Variables")
b = ggplot(onedf2, aes(x = avgtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Average Temperature (°C)", y = "Percent Cover")
c = ggplot(onedf2, aes(x = maxtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Maximum Temperature (°C)", y = "Percent Cover")
d = ggplot(onedf2, aes(x = anomalies, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Average Anomaly (°C)", y = "Percent Cover")
e = ggplot(onedf2, aes(x = maxanomaly, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Maximum Anomaly (°C)", y = "Percent Cover")
