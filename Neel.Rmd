...
g_model3 = gam(percentcoverperc ~ maxtempvector+ avgtempvector + s(maxanomaly, df = 1.2) +
            ...
            family = "binomial", data = onedf)
summary(g_model3)
plot.Gam(g_model3, ylab = "Effect on GAM", xlab = "Maximum Temperature (°C)")
```

``` {r}

a = ggplot(onedf, aes(x = year, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Year", y = "Percent Cover")
b = ggplot(onedf, aes(x = avgtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "avg temp", y = "Percent Cover")
c = ggplot(onedf, aes(x = maxtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "max temp", y = "Percent Cover")
d = ggplot(onedf, aes(x = anomalies, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "avg anomaly", y = "Percent Cover")

(a + b) / (c + d)

e = ggplot(onedf, aes(x = year, y = meanpercentcover)) + geom_boxplot()
f = ggplot(onedf, aes(x = avgtempvector, y = meanpercentcover)) + geom_boxplot()
g = ggplot(onedf, aes(x = maxtempvector, y = meanpercentcover)) + geom_boxplot()
h = ggplot(onedf, aes(x = anomalies, y = meanpercentcover)) + geom_boxplot()
...
i = ggplot(onedf2, aes(x = year, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "Year - 1993", y = "Percent Cover")
j = ggplot(onedf2, aes(x = avgtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "avg temp - 1993", y = "Percent Cover")
k = ggplot(onedf2, aes(x = maxtempvector, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "max temp - 1993", y = "Percent Cover")
m = ggplot(onedf2, aes(x = anomalies, y = meanpercentcover)) + geom_point() + geom_smooth() + theme_bw() + labs(x = "avg anomaly - 1993", y = "Percent Cover")
...
finaldf = finaldf %>% 
  ...
  mutate(changevector = changevector * 10)
ggplot(finaldf) + geom_point(aes(x = changevector, y = percentcover)) + geom_smooth(aes(x = changevector, y = percentcover)) + labs(x = "RCP", y = "Giant Kelp Percent Cover", title = "Kelp Cover Under Different RCPs") + theme_bw() + ylim(2.4, 2.8)
```
...
ggplot(final2df) + geom_point(aes(x = anom, y = percentcover)) + geom_smooth(aes(x = anom, y = percentcover)) + labs(x = "Maximum Heat Wave Intensity (Anomaly in °C)", y = "Giant Kelp Percent Cover", title = "Kelp Cover Under RPC 8.5 Conditions") + theme_bw()
```
